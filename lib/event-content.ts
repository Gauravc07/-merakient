// Current event, shown on the home page. Images live in public/images/.
// Date, times, table count and prices are NOT here — they come live from the bidding
// tables (set them with scripts/sql/03-set-bidding-window.sql).
