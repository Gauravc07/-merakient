...
export default function DynamicTableLayout({
  ...
  return (
    <div className="relative w-full h-[600px] bg-black rounded-3xl border-4 border-yellow-400 shadow-2xl shadow-yellow-500/20 p-6 overflow-hidden">
      ...
      <LayoutElement
        id="S6"
        position={{ top: "30%", left: "22%", width: "30px", height: "60px" }}
        category="VIP"
        pax="5"
        shape="rectangle"
        tables={tables}
      ...
      <LayoutElement
        id="S3"
        position={{ top: "30%", left: "72%", width: "30px", height: "60px" }}
        category="VIP"
        pax="6-8"
        tables={tables}
        hoveredTable={hoveredTable}
      ...
      <LayoutElement
        id="console"
        position={{ top: "5%", left: "33%", width: "100px", height: "60px" }}
        shape="rectangle"
        label="CONSOLE"
        isStaticLabel={true} // Mark as static label
        tables={tables}
      ...
      <LayoutElement
        id="B2"
        position={{ top: "45%", left: "7%", width: "30px", height: "90px" }}
        category="VIP"
        pax="6-8"
        tables={tables}
        hoveredTable={hoveredTable}
      ...
      <LayoutElement
        id="B1"
        position={{ top: "64%", left: "7%", width: "30px", height: "90px" }}
        category="VIP"
        pax="6-8"
        tables={tables}
        hoveredTable={hoveredTable}
      ...
      <LayoutElement
        id="S5"
        position={{ top: "48%", left: "22%", width: "30px", height: "60px" }}
        category="VIP"
        pax="5"
        shape="rectangle"
        tables={tables}
      ...
      <LayoutElement
        id="S2"
        position={{ top: "48%", left: "72%", width: "30px", height: "60px" }}
        category="VIP"
        pax="6-8"
        tables={tables}
        hoveredTable={hoveredTable}
      ...
      <LayoutElement
        id="S4"
        position={{ top: "66%", left: "22%", width: "30px", height: "60px" }}
        category="VIP"
        pax="6-8"
        tables={tables}
        hoveredTable={hoveredTable}
      ...
      <LayoutElement
        id="S1"
        position={{ top: "66%", left: "72%", width: "30px", height: "60px" }}
        category="VIP"
        pax="5"
        shape="rectangle"
        tables={tables}
...
<LayoutElement
  id="A3"
  position={{ top: "26%", left: "85%", width: "30px", height: "90px" }}
  category="VIP"
  pax="6-8"
  tables={tables}
  hoveredTable={hoveredTable}
...
<LayoutElement
  id="A2"
  position={{ top: "45%", left: "85%", width: "30px", height: "90px" }}
  category="VIP"
  pax="6-8"
  tables={tables}
  hoveredTable={hoveredTable}
...
<LayoutElement
  id="A1"
  position={{ top: "64%", left: "85%", width: "30px", height: "90px" }}
  category="VIP"
  pax="6-8"
  tables={tables}
  hoveredTable={hoveredTable}
